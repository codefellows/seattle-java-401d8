...
public final class Potion implements Model {
  ...
  private final @ModelField(targetType="Student") @BelongsTo(targetName = "potionStudentId", type = Student.class) Student student;
  ...
  private Potion(String id, String name, Student student, Boolean success, String color, String studentPotionsId) {
    this.id = id;
    this.name = name;

...
public final class Potion2 implements Model {
  ...
  public static final QueryField STUDENT_POTIONS_ID = field("studentPotionsId");
  ...
  private final @ModelField(targetType="ID") String studentPotionsId;
  public String getId() {
      return id;
  }
  ...
  public String getStudentPotionsId() {
      return studentPotionsId;
  }

  private Potion2(String id, String name, Student student, Boolean success, String color, String studentPotionsId) {
    this.id = id;
    this.name = name;
    this.student = student;
    this.success = success;
    this.color = color;
    this.studentPotionsId = studentPotionsId;
  }
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), potion.getId()) &&
              ...
              ObjectsCompat.equals(getStudentPotionsId(), potion.getStudentPotionsId());
      }
  }
  ...
  @Override
   public String toString() {
    return new StringBuilder()
      ...
      .append("studentPotionsId=" + String.valueOf(getStudentPotionsId()))
      .append("}")
      .toString();
  }
   ...
   */
  public static Potion2 justId(String id) {
    try {
  ...
  public interface BuildStep {
    ...
    BuildStep studentPotionsId(String studentPotionsId);
  }
  ...
  public static class Builder implements BuildStep {
    ...
    private String studentPotionsId;
    @Override
     public Potion2 build() {
    ...
    @Override
     public BuildStep studentPotionsId(String studentPotionsId) {
        this.studentPotionsId = studentPotionsId;
        return this;
    }
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, Student student, Boolean success, String color, String studentPotionsId) {
      super.id(id);
      super.name(name)
        .student(student)
        .success(success)
        .color(color)
        .studentPotionsId(studentPotionsId);
    }
    ...
    @Override
     public CopyOfBuilder studentPotionsId(String studentPotionsId) {
      return (CopyOfBuilder) super.studentPotionsId(studentPotionsId);
    }
  }

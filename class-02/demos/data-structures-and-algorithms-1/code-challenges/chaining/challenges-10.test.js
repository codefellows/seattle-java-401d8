...
const createServer = () => {
  ...
  function yummyArray(req, res)
  {
    const favoritefoods = ["Lamb Chops","Taco's", "Pizza"]
    res.status(200).send(favoritefoods)
  }
  
  function myStory(req, res)
  {
    let story = "My name is David. I\'ve been stuck in you computer for a few years now. It\'s dark and lonely in here please don\'t leave."

...
const raisedToTheThird = (arr) => {
  let returnArray = [];
  arr.forEach(element => {
    returnArray.push(Math.pow(element, 3));
  });
  return returnArray;
}
/* ------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------ */
const setStatusAsAuthor = (people) => people.forEach(function (obj) {obj.isAuthor = true});
...
------------------------------------------------------------------------------------------------ */
const append = (arr1, arr2) => arr2.forEach(function (obj) {arr1.push(obj)});
/* ------------------------------------------------------------------------------------------------
TESTS

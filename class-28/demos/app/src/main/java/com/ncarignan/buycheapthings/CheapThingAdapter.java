...
public class CheapThingAdapter extends RecyclerView.Adapter<CheapThingAdapter.CheapThingViewHolder> {
    ...
    public ArrayList<CheapThing> cheapThings;
    public OnInteractWithCheapThingListener listener;


    public CheapThingAdapter(ArrayList<CheapThing> cheapThings, OnInteractWithCheapThingListener listener){
...
// TODO: 2 start here after extending the class
        ...
        view.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                listener.cheapThingListener(viewHolder.cheapThing);
            }
        });
    ...
    public static interface OnInteractWithCheapThingListener {

...
public final class Store implements Model {
  ...
  private final @ModelField(targetType="CheapItem") @HasMany(associatedWith = "foundAt", type = CheapItem.class) List<CheapItem> cheapItems = null;
  public String getId() {
      return id;
  }
  ...
  public List<CheapItem> getCheapItems() {
      return cheapItems;
  }
  
  private Store(String id, String name, String address) {
    this.id = id;
    this.name = name;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), store.getId()) &&
              ...
              ObjectsCompat.equals(getAddress(), store.getAddress());
      }
  }

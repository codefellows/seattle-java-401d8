...
public final class CheapItem implements Model {
  ...
  public static final QueryField FOUND_AT = field("cheapItemFoundAtId");
  ...
  public final @ModelField(targetType="Store") @BelongsTo(targetName = "cheapItemFoundAtId", type = Store.class) Store foundAt;
  public String getId() {
      return id;
  }
  ...
  public Store getFoundAt() {
      return foundAt;
  }
  
  public CheapItem(String id, String thingName, Integer quantity, Float price, Store foundAt) {
    this.id = id;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), cheapItem.getId()) &&
              ...
              ObjectsCompat.equals(getFoundAt(), cheapItem.getFoundAt());
      }
  }
  ...
  public interface BuildStep {
    ...
    BuildStep foundAt(Store foundAt);
  }
  ...
  public static class Builder implements BuildStep {
    ...
    @Override
     public BuildStep foundAt(Store foundAt) {
        this.foundAt = foundAt;
        return this;
    }
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String thingName, Integer quantity, Float price, Store foundAt) {
      super.id(id);
    ...
    @Override
     public CopyOfBuilder foundAt(Store foundAt) {

...
const NameIntroductionIntent = { // if they say my name is Nicholas
  canHandle(handlerInput) {
  
    // Get the data from the speach unit that we are handling
    ...
    return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
      && Alexa.getIntentName(handlerInput.requestEnvelope) === 'NameIntroductionIntent';
  },
  async handle(handlerInput) {
    ...
    const theirName = Alexa.getSlotValue(handlerInput.requestEnvelope, 'name');

    return handlerInput.responseBuilder
      .speak(requestAttributes.t('INTRODUCTION_RESPONSE', theirName))

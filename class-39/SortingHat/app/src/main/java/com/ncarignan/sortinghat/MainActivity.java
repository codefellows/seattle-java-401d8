    ...
    public void uploadFile(File f, String key){
        ...
        Amplify.Storage.uploadFile(
                ...
                result -> {
                    ...
                    AnalyticsEvent event = AnalyticsEvent.builder()
                            .name("uploadFile")
                            .addProperty("Filename", f.getName()).build();
                    Amplify.Analytics.recordEvent(event);
                },
...
// Apply the adapter to the spinner
    ...
    public void configureAws(){
        try {
            ...
            Amplify.addPlugin(new AWSPinpointAnalyticsPlugin(getApplication())); // Class 39: little different than the docs
